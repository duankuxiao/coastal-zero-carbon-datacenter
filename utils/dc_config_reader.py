...
class DC_Config:
    ...
    def _setup_config(self):
        ...
        self.SEAWATER_AUTO_SIZE_FLOW = seawater_value('SEAWATER_AUTO_SIZE_FLOW', 'auto_size_seawater_flow', True)
        self.SEAWATER_MAX_FLOW_PER_UNIT_M3_S = seawater_value('SEAWATER_MAX_FLOW_PER_UNIT_M3_S', 'max_seawater_flow_per_unit_m3_s', self.SEAWATER_MAX_FLOW_M3_S)
        self.SEAWATER_HEAT_EXCHANGER_UNIT_COUNT = seawater_value('SEAWATER_HEAT_EXCHANGER_UNIT_COUNT', 'heat_exchanger_unit_count', 1)
        self.SEAWATER_BASE_HEAT_EXCHANGER_UNIT_COUNT = seawater_value('SEAWATER_BASE_HEAT_EXCHANGER_UNIT_COUNT', 'base_heat_exchanger_unit_count', 1)
        self.SEAWATER_HEAT_EXCHANGER_UA_W_PER_K = seawater_value('SEAWATER_HEAT_EXCHANGER_UA_W_PER_K', 'heat_exchanger_ua_w_per_k', 0.0)
        self.SEAWATER_HEAT_EXCHANGER_UA_PER_UNIT_W_PER_K = seawater_value('SEAWATER_HEAT_EXCHANGER_UA_PER_UNIT_W_PER_K', 'heat_exchanger_ua_per_unit_w_per_k', self.SEAWATER_HEAT_EXCHANGER_UA_W_PER_K)
        self.SEAWATER_AUTO_SIZE_HEAT_EXCHANGERS = seawater_value('SEAWATER_AUTO_SIZE_HEAT_EXCHANGERS', 'auto_size_heat_exchangers', self.SEAWATER_AUTO_SIZE_FLOW)
        self.SEAWATER_DESIGN_HEAT_REJECTION_FACTOR = seawater_value('SEAWATER_DESIGN_HEAT_REJECTION_FACTOR', 'design_heat_rejection_factor', 1.25)

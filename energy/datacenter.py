import os
import numpy as np
from energy.seawater_heat_pump import calculate_seawater_cooling, default_seawater_cooling_result
...
class CPU():
    ...
    def itfan_curve2(self, ):
        ...
        self.m_itfan = (self.cpu_config.IT_FAN_AIRFLOW_RATIO_UB[0] - self.cpu_config.IT_FAN_AIRFLOW_RATIO_LB[0]) / (
    ...
    def compute_datacenter_IT_load_outlet_temp(self, ITE_load_pct_list, CRAC_setpoint):
        ...
        for rack, rack_supply_approach_temp, ITE_load_pct, rack_multiplier \
            ...
            if outlet_temp - rack_inlet_temp < 2:
                outlet_temp = rack_inlet_temp + 2.0
...
def calculate_seawater_cooling_power(CRAC_cooling_load, CRAC_Fan_load, CW_pump_load,
    ...
    """Calculate seawater-source cooling power through the detailed submodel."""
    return calculate_seawater_cooling(
...
def calculate_HVAC_power_detailed(CRAC_setpoint, avg_CRAC_return_temp, ambient_temp,
    ...
    seawater = default_seawater_cooling_result(seawater_temp)
    ...
    elif cooling_mode in (
            "seawater",
            "seawater_heat_pump",
            "seawater_hybrid",
            "seawater_hybrid_cooling",
            "seawater_free_cooling",
            "free_cooling",
            "hybrid_cooling",
            "mechanical_heat_pump",
    ):
    ...
    return {
        ...
        "seawater_required_flow_rate_m3_s": seawater["seawater_required_flow_rate_m3_s"],
        "seawater_max_flow_rate_m3_s": seawater["seawater_max_flow_rate_m3_s"],
        "seawater_max_flow_per_unit_m3_s": seawater["seawater_max_flow_per_unit_m3_s"],
        "seawater_flow_per_unit_m3_s": seawater["seawater_flow_per_unit_m3_s"],
        "seawater_heat_exchange_unit_count": seawater["seawater_heat_exchange_unit_count"],
        "seawater_cooling_mode": seawater["cooling_mode"],
        "seawater_available_capacity_w": seawater["available_capacity_w"],
        "seawater_heat_exchanger_capacity_w": seawater["heat_exchanger_capacity_w"],
        "seawater_heat_pump_available_capacity_w": seawater["heat_pump_available_capacity_w"],
        "seawater_free_cooling_served_w": seawater["free_cooling_served_w"],
        "seawater_mechanical_cooling_served_w": seawater["mechanical_cooling_served_w"],
        "seawater_cooling_load_served_w": seawater["cooling_load_served_w"],
        "seawater_unmet_cooling_load_w": seawater["unmet_cooling_load_w"],
        "seawater_compressor_power_w": seawater["compressor_power_w"],
        "seawater_effective_cop": seawater["effective_cop"],
        "seawater_compressor_cop": seawater["compressor_cop"],
        "seawater_heat_rejection_w": seawater["heat_rejection_w"],
        "seawater_part_load_ratio": seawater["part_load_ratio"],
        "seawater_cycling_ratio": seawater["cycling_ratio"],
        "seawater_source_entering_temp_c": seawater["source_entering_temp_c"],
        "seawater_source_leaving_temp_c": seawater["source_leaving_temp_c"],
        "seawater_chilled_water_supply_temp_c": seawater["chilled_water_supply_temp_c"],
        "seawater_chilled_water_return_temp_c": seawater["chilled_water_return_temp_c"],
        "seawater_free_cooling_fraction": seawater["free_cooling_fraction"],
        "seawater_mechanical_cooling_fraction": seawater["mechanical_cooling_fraction"],
        "seawater_chilled_water_pump_power_w": seawater["chilled_water_pump_power_w"],
